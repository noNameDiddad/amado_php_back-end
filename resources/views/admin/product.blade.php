    ...
    <table class="table">
        @if($data_table->count() != 0)
            ...
            <tr>
                ...
                @isset($data_table[0]->category_id)<th scope="col">category_id</th>@endisset
            ...
            @foreach($data_table as $row)
                <tr>
                    ...
                    @isset($row->category_id)<td>{{$row->category_id}}</td>@endisset
                    @isset($row->image_path)<td><a href="{{asset('storage/images/'.$row->image_path)}}"><Фото></Фото></a></td>@endisset
